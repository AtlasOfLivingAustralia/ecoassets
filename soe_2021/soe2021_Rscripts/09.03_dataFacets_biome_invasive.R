# Number of invasive species by biome regions
sppBybiome <- ala %>%
...
sppBybiome1 <- setDT(sppBybiome)[, .(sppBybiome_invasive = .N),
                               keyby = c("biome", "YearRange", "griis_status")]
sppBybiome1 <- sppBybiome1 %>% 
  dplyr::select(biome, YearRange, sppBybiome_invasive)

fwrite(sppBybiome1, "cache/sumTable/biome/sppBybiome_invasive.csv")
...
colnames(df_final)<- c("biome", "YearRange", "invasive_new_species",
                       "invasive_last_seen_species")

fwrite(df_final, "cache/sumTable/biome/SpeciesFirst&LastObserved_invasive.csv")
...
fwrite(sppInPa, "cache/sumTable/biome/sppInIndPa_invasive.csv")
...
df_final <- df_final %>%
  dplyr::select(biome, YearRange, new_species, last_seen_species)
colnames(df_final)<- c("biome", "YearRange", "invasive_sppInIndPa_new_species",
                       "invasive_sppInIndPa_last_seen_species")

fwrite(df_final, "cache/sumTable/biome/SpeciesFirst&LastObserved_invasive_sppInInd.csv")
...
fwrite(sppOnlyInIndPa, "cache/sumTable/biome/invasive_sppOnlyInIndPa.csv")
fwrite(sppOnlyOutIndPa, "cache/sumTable/biome/invasive_sppOnlyOutIndPa.csv")
...
df_final <- df_final %>%
  dplyr::select(biome, YearRange, new_species, last_seen_species)
colnames(df_final)<- c("biome", "YearRange", "invasive_sppOnlyInIndPa_new_species",
                       "invasive_sppOnlyInIndPa_last_seen_species")

fwrite(df_final, "cache/sumTable/biome/SpeciesFirst&LastObserved_invasive_sppOnlyInIndPa.csv")
...
df_final <- df_final %>%
  dplyr::select(biome, YearRange, new_species, last_seen_species)
colnames(df_final)<- c("biome", "YearRange", "invasive_sppOnlyOutIndPa_new_species",
                       "invasive_sppOnlyOutIndPa_last_seen_species")

fwrite(df_final, "cache/sumTable/biome/SpeciesFirst&LastObserved_invasive_sppOnlyOutIndPa.csv")
...
df_final <- df_final %>%
  dplyr::select(biome, YearRange, new_species, last_seen_species)
colnames(df_final)<- c("biome", "YearRange", "invasive_sppInPa_new_species",
                       "invasive_sppInPa_last_seen_species")

fwrite(df_final, "cache/sumTable/biome/SpeciesFirst&LastObserved_invasive_sppInPa.csv")
...
fwrite(sppOnlyInPa, "cache/sumTable/biome/invasive_sppOnlyInPa.csv")
fwrite(sppOnlyOutPa, "cache/sumTable/biome/invasive_sppOnlyOutPa.csv")
...
df_final <- df_final %>%
  dplyr::select(biome, YearRange, new_species, last_seen_species)
colnames(df_final)<- c("biome", "YearRange", "invasive_sppOnlyInPa_new_species",
                       "invasive_sppOnlyInPa_last_seen_species")

fwrite(df_final, "cache/sumTable/biome/SpeciesFirst&LastObserved_invasive_sppOnlyInPa.csv")
...
df_final <- df_final %>%
  dplyr::select(biome, YearRange, new_species, last_seen_species)
colnames(df_final)<- c("biome", "YearRange", "invasive_sppOnlyOutPa_new_species",
                       "invasive_sppOnlyOutPa_last_seen_species")

fwrite(df_final, "cache/sumTable/biome/SpeciesFirst&LastObserved_invasive_sppOnlyOutPa.csv")
