# Number of introduced species by landUseZone regions
...
sppBylandUseZone1 <- setDT(sppBylandUseZone)[, .(sppBylandUseZone_introduced = .N),
...
fwrite(sppBylandUseZone1, "cache/sumTable/landUseZone/sppBylandUseZone_introduced.csv")
...
colnames(df_final)<- c("landUseZone", "YearRange", "introduced_new_species",
                       "introduced_last_seen_species")

fwrite(df_final, "cache/sumTable/landUseZone/SpeciesFirst&LastObserved_introduced.csv")
...
fwrite(sppInIndPa, "cache/sumTable/landUseZone/sppInIndPa_introduced.csv")
...
df_final <- df_final %>%
  dplyr::select(landUseZone, YearRange, new_species, last_seen_species)
colnames(df_final)<- c("landUseZone", "YearRange", "introduced_sppInIndPa_new_species",
                       "introduced_sppInIndPa_last_seen_species")

fwrite(df_final, "cache/sumTable/landUseZone/SpeciesFirst&LastObserved_introduced_sppInInd.csv")
...
fwrite(sppOnlyInPa, "cache/sumTable/landUseZone/introduced_sppOnlyInPa.csv")
fwrite(sppOnlyOutPa, "cache/sumTable/landUseZone/introduced_sppOnlyOutPa.csv")
...
df_final <- df_final %>%
  dplyr::select(landUseZone, YearRange, new_species, last_seen_species)
colnames(df_final)<- c("landUseZone", "YearRange", "introduced_sppOnlyInPa_new_species",
                       "introduced_sppOnlyInPa_last_seen_species")

fwrite(df_final, "cache/sumTable/landUseZone/SpeciesFirst&LastObserved_introduced_sppOnlyInPa.csv")
...
df_final <- df_final %>%
  dplyr::select(landUseZone, YearRange, new_species, last_seen_species)
colnames(df_final)<- c("landUseZone", "YearRange", "introduced_sppOnlyOutPa_new_species",
                       "introduced_sppOnlyOutPa_last_seen_species")

fwrite(df_final, "cache/sumTable/landUseZone/SpeciesFirst&LastObserved_introduced_sppOnlyOutPa.csv")
...
df_final <- df_final %>%
  dplyr::select(landUseZone, YearRange, new_species, last_seen_species)
colnames(df_final)<- c("landUseZone", "YearRange", "introduced_sppInPa_new_species",
                       "introduced_sppInPa_last_seen_species")

fwrite(df_final, "cache/sumTable/landUseZone/SpeciesFirst&LastObserved_introduced_sppInPa.csv")
...
fwrite(sppOnlyInIndPa, "cache/sumTable/landUseZone/introduced_sppOnlyInIndPa.csv")
fwrite(sppOnlyOutIndPa, "cache/sumTable/landUseZone/introduced_sppOnlyOutIndPa.csv")
...
df_final <- df_final %>%
  dplyr::select(landUseZone, YearRange, new_species, last_seen_species)
colnames(df_final)<- c("landUseZone", "YearRange", "introduced_sppOnlyInIndPa_new_species",
                       "introduced_sppOnlyInIndPa_last_seen_species")

fwrite(df_final, "cache/sumTable/landUseZone/SpeciesFirst&LastObserved_introduced_sppOnlyInIndPa.csv")
...
df_final <- df_final %>%
  dplyr::select(landUseZone, YearRange, new_species, last_seen_species)
colnames(df_final)<- c("landUseZone", "YearRange", "introduced_sppOnlyOutIndPa_new_species",
                       "introduced_sppOnlyOutIndPa_last_seen_species")

fwrite(df_final, "cache/sumTable/landUseZone/SpeciesFirst&LastObserved_introduced_sppOnlyOutIndPa.csv")
