...
ala <- ala[!(is.na(ala$landUseZone) | ala$landUseZone == ""),]
...
ala <- ala %>% 
  dplyr::select(species_guid, YearRange, landUseZone, basisOfRecord, capad_status, indigenous_Status, wons_status, griis_status, conservation_status)
